...
namespace ambiens.archtoolkit.atmaterials.utils
{
    ...
    public class Downloadcc0TexturesHandler : MonoBehaviour
    {
        ...
        public static void RefreshMaterialNames()
        {
            ...
            {
                if (GraphicsSettings.defaultRenderPipeline.name.ToLower().Contains("hd"))
                {
                    ...
                    GraphicsSettings.defaultRenderPipeline.name.ToLower().Contains("universal")
                    || GraphicsSettings.defaultRenderPipeline.name.ToLower().Contains("urp")
                )
                {
                    CurrentRenderPipeline = RenderPipelineType.URP;
                }
                else if (GraphicsSettings.defaultRenderPipeline.name.ToLower().Contains("lwrp"))
                {
                    CurrentRenderPipeline = RenderPipelineType.URP;
