...
public class ClearBenchTests
{
    ...
    public void TestClearBenches()
    {
        ...
        publicSpaceManager.GetType().GetMethod("ClearBenches", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            .Invoke(publicSpaceManager, null);
